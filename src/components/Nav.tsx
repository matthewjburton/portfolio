...
const Nav: React.FC = () => {
    ...
    return (
        <div className={`w-full bg-container dark:bg-container-dark flex flex-row justify-center items-center gap-8 p-6 text-2xl z-20 ${isSticky ? 'sticky top-0 shadow-md' : ''}`}>
